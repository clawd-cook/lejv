...
<template>
  <view class="container">
    <slider :value="value" min="0" max="100" step="5" @change="handleChange" />
    <text>当前值：{{ value }}</text>
  </view>
</template>
...
<template>
  <view class="container">
    <view class="brightness-control">
      ...
      <slider :value="brightness" min="0" max="100" @change="handleBrightnessChange" />
    </view>
  </view>
</template>
...
<template>
  <view class="container">
    <view class="price-range">
      ...
      <slider :value="minPrice" min="0" max="1000" step="10" @change="handleMinPriceChange" />
      <text>最低价格：{{ minPrice }}</text>
      <slider :value="maxPrice" min="0" max="1000" step="10" @change="handleMaxPriceChange" />
