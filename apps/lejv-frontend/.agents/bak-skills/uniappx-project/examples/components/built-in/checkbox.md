...
<template>
  <view class="container">
    <checkbox value="agree" :checked="isAgreed" @tap="handleChange"> 我已阅读并同意协议 </checkbox>
  </view>
</template>
  ...
  <view class="container">
    <checkbox-group @change="handleGroupChange">
      <label class="checkbox-item">
        <checkbox value="all" :checked="isAllSelected" @tap="handleSelectAll" />
        <text>全选</text>
      </label>
      <label v-for="item in list" :key="item.id" class="checkbox-item">
