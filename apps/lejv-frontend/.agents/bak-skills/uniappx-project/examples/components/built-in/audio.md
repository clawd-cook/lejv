...
<template>
  <view class="container">
    <view v-for="(item, index) in audioList" :key="index" class="audio-item">
      <text class="audio-title">{{ item.title }}</text>
      <audio :src="item.src" controls class="audio-player" @play="handleAudioPlay(index)"></audio>
    </view>
  </view>
</template>
...
<template>
  <view class="container">
    <audio :src="audioSrc" controls @timeupdate="handleTimeUpdate" class="audio-player"></audio>
