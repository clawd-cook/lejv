...
<template>
  <view class="container">
    <!-- 保留当前页面，可以返回 -->
    <navigator url="/pages/detail/detail" open-type="navigate"> 保留页面跳转 </navigator>

    <!-- 关闭当前页面，不能返回 -->
    <navigator url="/pages/detail/detail" open-type="redirect"> 关闭页面跳转 </navigator>

    <!-- 关闭所有页面，重新启动 -->
    <navigator url="/pages/index/index" open-type="reLaunch"> 重新启动 </navigator>
...
<template>
  <view class="container">
    <navigator v-if="isLogin" url="/pages/user/user" open-type="navigate"> 个人中心 </navigator>
    <navigator v-else url="/pages/login/login" open-type="navigate"> 登录 </navigator>
  </view>
</template>
