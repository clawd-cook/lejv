...
```vue
┌─components ├─hybrid │ └─html │ ├─css │ │ └─test.css │ ├─img │ │ └─icon.png │ ├─js │ │ └─test.js │
└─local.html ├─pages │ └─index │ └─index.vue ├─static ├─main.js ├─App.vue ├─manifest.json
└─pages.json
```
...
<html>
  ...
  <body>
    ...
    <script
      ...
      src="https://gitcode.com/dcloud/uni-app/tree/dev/dist/uni.webview.1.5.6.js"
    ></script>
    <script type="text/javascript">
