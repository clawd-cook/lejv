  ...
  data() {
    return {
      indexedList1: [
        {
          letter: "A",
          data: [{ name: "Apple" }, { name: "Ant" }, { name: "Air" }],
        },
        {
          letter: "B",
          data: [{ name: "Banana" }, { name: "Book" }, { name: "Ball" }],
        },
        {
          letter: "C",
          data: [{ name: "Cat" }, { name: "Car" }, { name: "Cup" }],
        },
      ],
      indexedList2: [
        {
          letter: "热门",
          data: [{ name: "北京" }, { name: "上海" }, { name: "广州" }],
        },
        {
          letter: "A",
          data: [{ name: "安徽" }, { name: "澳门" }],
        },
        {
          letter: "B",
          data: [{ name: "北京" }],
