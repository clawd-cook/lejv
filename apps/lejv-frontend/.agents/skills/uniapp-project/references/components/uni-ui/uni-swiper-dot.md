...
```vue
export default { data() { return { info: [{ content: '内容 A' }, { content: '内容 B' }, { content:
'内容 C' }], current: 0, mode: 'round', } }, methods: { change(e) { this.current = e.detail.current;
} } }
```
    ...
    <uni-section title="模式选择" type="line">
      <view class="example-body">
        ...
        <view
          ...
          ><text class="example-body-item-text">dot</text></view
        >
        <view
        ...
        <view
          ...
          ><text class="example-body-item-text">nav</text></view
        >
        <view
          :class="{ active: modeIndex === 4 }"
          class="example-body-item"
